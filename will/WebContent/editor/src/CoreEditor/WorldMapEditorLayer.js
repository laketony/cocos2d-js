var WorldMapEditorLayer = cc.Layer.extend({
	...
	drawMap : function(data) {
		...
		// 绘制新手村
		this.drawLineMap.drawRect(cc.p(-450, -450), cc.p(970, 652), null, 6, cc.color(0, 255, 153, 255));
		this.drawLineMap.drawRect(cc.p(-450, -450), cc.p(970, 652), null, 4, this.lineColor);
